...
Napomena: `order by ef.ciklus` daje najstariji ciklus prvi, dakle **najveće kašnjenje prvo** — `dana_do_ciklusa` je negativan, pa je to traženo „silazno po kašnjenju".
